...
public class ComputeGreeks extends JFrame {
  ...
  public ComputeGreeks(double s, double k, double t, double r, double q, double vol) {
    ...
    deltaCallLabel.setForeground(Color.WHITE);
    ...
    greekCall1.setForeground(Color.WHITE);
    ...
    vegaCallLabel.setForeground(Color.WHITE);
    ...
    greekCall2.setForeground(Color.WHITE);
    ...
    psiCallLabel.setForeground(Color.WHITE);
    ...
    greekCall3.setForeground(Color.WHITE);
    ...
    thetaCallLabel.setForeground(Color.WHITE);
    ...
    greekCall4.setForeground(Color.WHITE);
    ...
    rhoCallLabel.setForeground(Color.WHITE);
    ...
    greekCall5.setForeground(Color.WHITE);
    ...
    gammaCallLabel.setForeground(Color.WHITE);
    ...
    greekCall6.setForeground(Color.WHITE);
    ...
    volgaCallLabel.setForeground(Color.WHITE);
    ...
    greekCall7.setForeground(Color.WHITE);
    ...
    param1.setForeground(Color.black);
    param1.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    param2.setBackground(Color.WHITE);
    param2.setForeground(Color.black);
    param2.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    param3.setBackground(Color.WHITE);
    param3.setForeground(Color.black);
    param3.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    param4.setBackground(Color.WHITE);
    param4.setForeground(Color.black);
    param4.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    paramtext5.setForeground(Color.WHITE);
    ...
    param5.setBackground(Color.WHITE);
    param5.setForeground(Color.black);
    param5.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    paramtext6.setForeground(Color.WHITE);
    ...
    param6.setBackground(Color.WHITE);
    param6.setForeground(Color.black);
    param6.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    enterLabel2.setForeground(Color.WHITE);
    ...
    deltaPutLabel.setForeground(Color.WHITE);
    ...
    greekPut1.setForeground(Color.WHITE);
    ...
    vegaPutLabel.setForeground(Color.WHITE);
    ...
    greekPut2.setForeground(Color.WHITE);
    ...
    psiPutLabel.setForeground(Color.WHITE);
    ...
    greekPut3.setForeground(Color.WHITE);
    ...
    thetaPutLabel.setForeground(Color.WHITE);
    ...
    greekPut4.setForeground(Color.WHITE);
    ...
    rhoPutLabel.setForeground(Color.WHITE);
    ...
    greekPut5.setForeground(Color.WHITE);
    ...
    gammaPutLabel.setForeground(Color.WHITE);
    ...
    greekPut6.setForeground(Color.WHITE);
    ...
    volgaPutLabel.setForeground(Color.WHITE);
    ...
    greekPut7.setForeground(Color.WHITE);
    ...
    paramtext1b.setForeground(Color.WHITE);
    ...
    param1b.setForeground(Color.black);
    param1b.setBackground(Color.WHITE);
    param1b.setBounds(175, 422, 100, 30);
    param1b.setVisible(true);
    param1b.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    paramtext2b.setForeground(Color.WHITE);
    ...
    param2b.setForeground(Color.black);
    param2b.setBackground(Color.WHITE);
    param2b.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    paramtext3b.setForeground(Color.WHITE);
    ...
    param3b.setForeground(Color.black);
    param3b.setBackground(Color.WHITE);
    param3b.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    paramtext4b.setForeground(Color.WHITE);
    ...
    param4b.setForeground(Color.black);
    param4b.setBackground(Color.WHITE);
    param4b.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    paramtext5b.setForeground(Color.WHITE);
    ...
    param5b.setForeground(Color.black);
    param5b.setBackground(Color.WHITE);
    param5b.setFont(new Font("Calibri", Font.BOLD, 17));
    ...
    paramtext6b.setForeground(Color.WHITE);
    ...
    param6b.setForeground(Color.black);
    param6b.setBackground(Color.WHITE);
    param6b.setFont(new Font("Calibri", Font.BOLD, 17));
